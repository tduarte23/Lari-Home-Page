...
export default function NossoTime(){
        return(
            ...
            <div id='bgrad' className='h-full mt-8 '>
                ...
                <div className='p-7 lg:p-20 flex flex-col lg:flex-row gap-12'>
                    <div className='w-50 h-50 bg-white lg:w-109 lg:h-112'>
                        <div className=''>
                            <img src={Time1} alt="" />
                        </div>
                    ...
                    <div className='w-50 h-50 bg-white lg:w-104 lg:h-109'>
                        <div className=''>
                            <img src={Time2} className='object-cover  w-full  lg:h-96' alt="Advogado" />
                        </div>
                        <div className='flex justify-center flex-col'>
                            <h2 className='text-2xl font-bold m-auto'>Larissa Vidal</h2>
                            <p className='font-semibold m-auto'>Advogada</p>
